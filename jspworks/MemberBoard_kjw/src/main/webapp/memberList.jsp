...
<body>
	...
	<div id="container">
		...
		<div style="margin-bottom: 20px; text-align: right; margin-right:35%">
			<p><a href="/logout.do" style="text-decoration:none; color:#AC7D88;">[관리자 로그아웃]</a>
		</div>
		<div>
					...
					<tr>
						...
						<td>
							<a href="./deleteMember.do?memberId=<c:out value="${member.memberId}" />"
							   ...
							   <button type="button" style="padding:10px; border:#85586F; background:#AC7D88; color:#F8ECD1;">삭제</button>
							</a> 
						</td>
					</tr>
					</c:forEach>
