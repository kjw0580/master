...
<body>
   ...
   <div class="container">
   	<div class="row">
   		...
   		%>
   		<div class="col-md-5">
   			<img src="./upload/<%=rs.getString("p_productImage")%>"alt="image" width="100%">
   		</div>
   		<div class="col-md-7">
		      <form action="./processUpdateProduct.jsp" method="post"
		         ...
		         <div class="form-group row">
		            ...
		            <div class="col-sm-3">
		               <input type="text" name="productId" id="productId" value="<%=rs.getString("p_id")%>" class="form-control">
		            </div>
		         </div>
		         <div class="form-group row">
		            <label class="col-sm-2">상품명</label>
		            <div class="col-sm-3">
		               <input type="text" name="pname" id="pname" value="<%=rs.getString("p_name")%>" class="form-control">
		            </div>
		         </div>
		         <div class="form-group row">
		         ...
		         <div class="form-group row">
		            ...
		            <div class="col-sm-3">
		               <input type="text" name="manufacturer" value="<%=rs.getString("p_manufacturer")%>" class="form-control">
		            </div>
		         </div>
		         <div class="form-group row">
		            <label class="col-sm-2">분류</label>
		            <div class="col-sm-3">
		               <input type="text" name="category" value="<%=rs.getString("p_category")%>" class="form-control">
		            </div>
		         </div>
		         <div class="form-group row">
		            <label class="col-sm-2">재고수</label>
		            <div class="col-sm-3">
		               <input type="text" name="unitsInStock" id="unitsInStock" value="<%=rs.getLong("p_unitsInStock")%>" class="form-control">
		            </div>
		         </div>
		         <div class="form-group row">
		            ...
		            <div class="col-sm-5">
		               ...
		               <label><input type="radio" name="condition" value="Old" checked>중고제품</label>
		               <label><input type="radio" name="condition" value="Refurbished">재생 제품</label>
